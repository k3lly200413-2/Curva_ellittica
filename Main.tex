...
Dalla definizione sopra si può capire dedurre che se una retta interseca una curva $E(a, b)$ in due punti \textit{P} e \textit{Q} allora la retta interseca anche un terzo punto \textit{R}. Se la retta è verticale invece, oltre ai punti \textit{P} e \textit{Q} interseca anche il punto all'infinito $\mathcal{O}$.
...
\begin{thebibliography}{9}
    ...
    Joseph H. Silverman \textit{The Arithmetic of Elliptic Curves}
